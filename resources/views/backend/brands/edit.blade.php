                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <textarea name="description" placeholder="Type here"
                                          class="form-control" rows="4">{{$brand->description}}</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- card end// -->
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <select name="status" class="form-select" id="status">
                                    <option value="publish" {{$brand->status == 'publish' ? 'selected' :
                                    'publish'}}>Published</option>
                                    <option value="draft" {{$brand->status == 'draft' ? 'selected' :
                                    'draft'}}>Draft</option>
                                    <option value="pending-approval" {{$brand->status == 'pending-approval' ? 'selected' :
