    ...
    <section class="content-main">
        ...
        <div class="container-xl px-4 mt-4">
            ...
            <nav class="nav nav-borders">
                ...
                <a class="nav-link" href="{{route('vendor.profile.password')}}">Change Password</a>
                            ...
                            <div class="card-body text-center">
                                ...
                                <img class="img-account-profile rounded-circle mb-2" id="profile_image" height="60" width="60"
                                     src="{{(!empty($user_data->profile->profile_image)) ? url
                                                         ('uploads/vendor/images/profile/'
                            .$user_data->profile->profile_image) : url('uploads/vendor/images/default/default-avatar.jpeg')
                            }}" alt="">
